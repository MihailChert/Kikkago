...
enum class InterpretatorKeyword{hajimaru, label, do_, to, break_, block, ugoku, henkamono, bunkiten, conf, conf1, conf2, kaku, cycle, zero, hitotsu, f1, f2, f3, addr, addrwokaku, mojiwokaku, shl, shr, empty, prob, inaddr, loop, kyouki, owari, int_, float_, double_, char_, bool_, string, array, print, sum, sub, mult, div, pow, sqrt, lt, gt, le, ge, eq, ne, factor, cnk, sin, cos, exp, ln, equal, run, mod, set, get, uniform, rand, normal, bernoulli, poisson, pop, append, write, read, lenght, jikannohajimaru, jikannoowari, mean, cumsum, dispersion, ceil, floor, round, trunc, histogram, goto_, tapeint, nsm};

enum class ParseStatus{OK, END, UD_OPERATION, UNHANDLED_OPERATION_WITH_TYPES, ALREADY_EXISTS, PARSE_ERROR, MATH_ERROR, CANT_OPEN_FILE};
